...
<div style="position: relative;">
    <img src="/Portafolio/res/img/ampalu.gif" alt="Animación" style="width: 100%;" />
    <div style="position: absolute; top: 22%; left: 50%; transform: translate(-20%, 165%); text-align: center;">
