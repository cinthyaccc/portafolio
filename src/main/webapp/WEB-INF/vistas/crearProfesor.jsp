    ...
    <form action="/Portafolio/CrearProfesor" method="post" onsubmit="return enviarFormulario(event)">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8">
                ...
                <span id="telefonoValidationMessage" class="error-message"></span>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8">
                ...
                <span id="gradoAcademicoValidationMessage" class="error-message""></span>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8">
                ...
                <span id="idNivelValidationMessage" class="error-message"></span>
            </div>
        </div>
...
<script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function validarCampos() {
                ...
                if (direccion.value.trim() === "") {
                    document.getElementById("telefonoValidationMessage").textContent = "Ingrese número de Tlf.";
                    isValid = false;
                } else {
                    document.getElementById("telefonoValidationMessage").textContent = "";
                }
                if (direccion.value.trim() === "") {
                    document.getElementById("gradoAcademicoValidationMessage").textContent = "Ingrese nivel de Estudios";
                    isValid = false;
                } else {
                    document.getElementById("gradoAcademicoValidationMessage").textContent = "";
                }
                if (direccion.value.trim() === "") {
                    document.getElementById("idNivelValidationMessage").textContent = "Ingrese id. Nivel";
                    isValid = false;
                } else {
                    document.getElementById("idNivelValidationMessage").textContent = "";
                }
                if (isValid) {
            ...
            gradoAcademico.addEventListener("input", validarCampos);
